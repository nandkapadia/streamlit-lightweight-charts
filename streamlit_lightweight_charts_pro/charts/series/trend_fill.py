...
The series now properly handles upper and lower trend lines based on trend direction:
- Uptrend (+1): Shows lower trend line below price as support (green fill)
- Downtrend (-1): Shows upper trend line above price as resistance (red fill)
"""
...
@chainable_property("upper_trend_line", LineOptions, allow_none=True)
@chainable_property("lower_trend_line", LineOptions, allow_none=True)
...
class TrendFillSeries(Series):
    ...
    The series now properly handles upper and lower trend lines:
    - Uptrend (+1): Shows lower trend line below price as support (green fill)
    - Downtrend (-1): Shows upper trend line above price as resistance (red fill)
    
    Attributes:
        upper_trend_line: Line options for the upper trend line (downtrend resistance)
        lower_trend_line: Line options for the lower trend line (uptrend support)
    ...
    def __init__(
        ...
        # Initialize line options for different trend types
        self._upper_trend_line = LineOptions(
            color="#F44336", line_width=2, line_style="solid"
        )  # Red for downtrend
        self._lower_trend_line = LineOptions(
            color="#4CAF50", line_width=2, line_style="solid"
        )  # Green for uptrend
