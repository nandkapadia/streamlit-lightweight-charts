...
@chainable_field("entry_marker_color_long", str, validator=lambda v: TradeVisualizationOptions._validate_color_static(v, "entry_marker_color_long"))
@chainable_field("entry_marker_color_short", str, validator=lambda v: TradeVisualizationOptions._validate_color_static(v, "entry_marker_color_short"))
@chainable_field("exit_marker_color_profit", str, validator=lambda v: TradeVisualizationOptions._validate_color_static(v, "exit_marker_color_profit"))
@chainable_field("exit_marker_color_loss", str, validator=lambda v: TradeVisualizationOptions._validate_color_static(v, "exit_marker_color_loss"))
...
@chainable_field("rectangle_color_profit", str, validator=lambda v: TradeVisualizationOptions._validate_color_static(v, "rectangle_color_profit"))
@chainable_field("rectangle_color_loss", str, validator=lambda v: TradeVisualizationOptions._validate_color_static(v, "rectangle_color_loss"))
@chainable_field("rectangle_fill_color_profit", str, validator=lambda v: TradeVisualizationOptions._validate_color_static(v, "rectangle_fill_color_profit"))
@chainable_field("rectangle_border_color_profit", str, validator=lambda v: TradeVisualizationOptions._validate_color_static(v, "rectangle_border_color_profit"))
@chainable_field("rectangle_border_color_loss", str, validator=lambda v: TradeVisualizationOptions._validate_color_static(v, "rectangle_border_color_loss"))
@chainable_field("line_width", int)
@chainable_field("line_style", str)
@chainable_field("line_color_profit", str, validator=lambda v: TradeVisualizationOptions._validate_color_static(v, "line_color_profit"))
@chainable_field("line_color_loss", str, validator=lambda v: TradeVisualizationOptions._validate_color_static(v, "line_color_loss"))
@chainable_field("arrow_size", int)
@chainable_field("arrow_color_profit", str, validator=lambda v: TradeVisualizationOptions._validate_color_static(v, "arrow_color_profit"))
@chainable_field("arrow_color_loss", str, validator=lambda v: TradeVisualizationOptions._validate_color_static(v, "arrow_color_loss"))
@chainable_field("zone_opacity", float)
@chainable_field("zone_color_long", str, validator=lambda v: TradeVisualizationOptions._validate_color_static(v, "zone_color_long"))
@chainable_field("zone_color_short", str, validator=lambda v: TradeVisualizationOptions._validate_color_static(v, "zone_color_short"))
...
@chainable_field("annotation_background", str, validator=lambda v: TradeVisualizationOptions._validate_color_static(v, "annotation_background"))
