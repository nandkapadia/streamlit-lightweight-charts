...
import pandas as pd
from .base import to_utc_timestamp, from_utc_timestamp
...
class Trade:
    ...
    def __post_init__(self):
        ...
        if isinstance(self._entry_timestamp, (int, float)) and isinstance(self._exit_timestamp, (int, float)):
    ...
    def to_markers(self, 
        ...
        """
        from ..data import Marker, MarkerShape, MarkerPosition
        ...
        entry_marker = Marker(
            ...
            position=MarkerPosition.BELOW_BAR if self.trade_type == TradeType.LONG else MarkerPosition.ABOVE_BAR,
            shape=MarkerShape.ARROW_UP if self.trade_type == TradeType.LONG else MarkerShape.ARROW_DOWN,
            color=entry_color,
            text=entry_text
        )
        ...
        exit_marker = Marker(
            ...
            position=MarkerPosition.ABOVE_BAR if self.trade_type == TradeType.LONG else MarkerPosition.BELOW_BAR,
            shape=MarkerShape.ARROW_DOWN if self.trade_type == TradeType.LONG else MarkerShape.ARROW_UP,
            color=exit_color,
            text=exit_text
        )
