...
from ..types import (
    Background, SolidColor, LineStyle, CrosshairMode,
    PriceScaleMode, HorzAlign, VertAlign
)
...
class LayoutOptions:
    ...
    background: Background = field(
        default_factory=lambda: Background.solid('#FFFFFF')
    )
    text_color: str = '#191919'
    font_size: int = 12
    font_family: str = '-apple-system, BlinkMacSystemFont, "Trebuchet MS", Roboto, Ubuntu, sans-serif'
