...
def main():
    ...
    st.write("This example tests the error handling improvements for annotations and other features.")
    ...
    chart_with_invalid_annotations = Chart(
        ChartOptions(
            width=800,
            height=400
        )
    ...
    chart_with_empty_annotations = Chart(
        ChartOptions(
            width=800,
            height=400
        )
    ...
    chart_with_valid_annotations = Chart(
        ChartOptions(
            width=800,
            height=400
        )
