...
def main():
    ...
    st.write("This example tests the fitContent functionality to ensure charts properly rescale to show all data on load.")
    ...
    candlestick_series1 = CandlestickSeries(
        data=ohlcv_data,
        name="Price Data",
        color="#2196F3"
    )
