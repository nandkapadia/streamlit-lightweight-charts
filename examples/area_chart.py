...
from streamlit_lightweight_charts_pro import SinglePaneChart, AreaSeries, create_chart
...
def method_chaining_example():
    ...
    .update_options(height=400, width=600, watermark="Sample Area Data", legend=True)
    .add_annotation(
