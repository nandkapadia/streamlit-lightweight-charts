...
def basic_method_chaining_demo():
    ...
    with col1:
        ...
        chart = (
            ...
            .add_annotation(
                create_arrow_annotation("2018-12-31", 22.67, "Year End", color="#00ff00")
            )
        )
...
def chart_builder_pattern_demo():
    ...
    with col1:
        ...
        chart = (
            ...
            .set_legend(True)
            .add_annotation(
                create_text_annotation("2018-12-25", 27.32, "Peak Volume", color="#ff0000")
            )
            .build()
        )
    ...
    with col2:
        ...
        chart = (
            builder.add_area_series(area_data, color="#4CAF50", fill_color="rgba(76, 175, 80, 0.3)")
            .set_height(400)
            .set_width(600)
            .set_watermark("Area Chart")
            .add_annotation(
                create_arrow_annotation("2019-04-08", 45.23, "Breakout", color="#FF5722")
            )
            .build()
        )
    ...
    chart = (
        SinglePaneChart(
            series=[
                ...
                HistogramSeries(data=volume_data, color="#FF9800", price_scale_id="left"),
            ]
        )
...
def annotations_layers_demo():
    ...
    with col1:
        ...
        chart = (
            ...
            .add_annotation(
                create_arrow_annotation("2018-12-31", 22.67, "Year End", color="#00ff00"), "events"
            )
    ...
    with col2:
        ...
        chart = (
            ...
            .add_annotation(
                create_arrow_annotation("2022-01-20", 9.51, "Earnings", color="#FF9800"),
                "fundamental",
            )
        )
...
def trade_visualization_demo():
    ...
    trades = [
        Trade(time="2022-01-17", price=10.0, type=TradeType.BUY, size=100, description="Entry"),
        Trade(time="2022-01-19", price=9.78, type=TradeType.SELL, size=100, description="Exit"),
        Trade(time="2022-01-20", price=9.51, type=TradeType.BUY, size=150, description="Re-entry"),
        Trade(
            time="2022-01-21", price=10.17, type=TradeType.SELL, size=150, description="Take profit"
        ),
    ]
    ...
    chart = (
        ...
        .add_annotation(
            create_text_annotation(
                ...
                "SELL 100 shares",
                color="#F44336",
                background_color="rgba(244, 67, 54, 0.2)",
            )
        )
        .add_annotation(
            create_text_annotation(
