...
def main():
    ...
    st.write("This example tests all the error handling improvements to ensure the library handles various error scenarios gracefully.")
    ...
    candlestick_series_manager = CandlestickSeries(
        data=ohlcv_data,
        name="Price with AnnotationManager",
        color="#607D8B"
    )
    ...
    annotation2 = create_arrow_annotation("2024-08-15", 120, "Manager Annotation 2", color="#F44336")
