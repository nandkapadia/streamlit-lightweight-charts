...
from streamlit_lightweight_charts_pro import SinglePaneChart, HistogramSeries, create_chart
from streamlit_lightweight_charts_pro.data import create_text_annotation
from examples.dataSamples import get_volume_data, get_dataframe_volume_data
...
def main():
    ...
    """
    st.set_page_config(
        page_title="Histogram Chart Example",
        page_icon="📊",
        layout="wide"
    )
