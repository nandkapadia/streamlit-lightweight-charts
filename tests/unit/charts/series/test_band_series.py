...
from streamlit_lightweight_charts_pro.data import BandData, Marker
...
class TestBandSeries:
    ...
    def test_band_series_to_dict(self):
        """Test BandSeries dictionary generation."""
        series = BandSeries(data=self.band_data)
        ...
        # Test data structure
        assert config["data"][0][ColumnNames.TIME] == 1704067200  # Unix timestamp
