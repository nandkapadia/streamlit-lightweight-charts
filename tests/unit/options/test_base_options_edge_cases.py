...
class TestOptionsProcessDictRecursively:
    ...
    def test_process_dict_recursively_with_nested_structures(self):
        ...
        data = {
            "level1": {
                "level2": {
                    "options": NestedOptions(color="#ff0000", width=2),
                    "simple": "value"
                }
            },
            "list_data": [
                {"item": NestedOptions(color="#00ff00", width=3)},
                "simple_item"
            ]
        }
...
class TestOptionsAnalyzeTypeForOptions:
    ...
    def test_analyze_type_for_options_direct_options(self):
        ...
        contains_options, options_class, is_dict_type = options._analyze_type_for_options(NestedOptions)
    ...
    def test_analyze_type_for_options_optional_options(self):
        ...
        contains_options, options_class, is_dict_type = options._analyze_type_for_options(optional_type)
    ...
    def test_analyze_type_for_options_optional_dict_options(self):
        ...
        contains_options, options_class, is_dict_type = options._analyze_type_for_options(optional_dict_type)
    ...
    def test_analyze_type_for_options_primitive_types(self):
        ...
        for primitive_type in [str, int, bool, float]:
            contains_options, options_class, is_dict_type = options._analyze_type_for_options(primitive_type)
    ...
    def test_analyze_type_for_options_none_type(self):
        ...
        contains_options, options_class, is_dict_type = options._analyze_type_for_options(type(None))
        assert contains_options is False
        assert options_class is None
        assert is_dict_type is False
    ...
    def test_analyze_type_for_options_complex_union(self):
        ...
        contains_options, options_class, is_dict_type = options._analyze_type_for_options(union_type)
        ...
        contains_options, options_class, is_dict_type = options._analyze_type_for_options(union_dict_type)
...
class TestOptionsAsdictEdgeCases:
    ...
    def test_asdict_with_complex_nested_structures(self):
        ...
        options.options_list = [
            NestedOptions(color="#0000ff", width=4)
        ]
