...
class TestTradeVisualizationOptionsConstruction:
    ...
    def test_default_construction(self):
        ...
        assert options.marker_size == 20
        assert options.show_pnl_in_markers is True
        assert options.rectangle_fill_opacity == 0.2
        ...
        assert options.show_trade_id is True
...
class TestTradeVisualizationOptionsSerialization:
    ...
    def test_to_dict_default_values(self):
        ...
        assert result["markerSize"] == 20
        assert result["showPnlInMarkers"] is True
        assert result["rectangleFillOpacity"] == 0.2
