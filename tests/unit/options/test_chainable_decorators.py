...
from streamlit_lightweight_charts_pro.charts.options import (
    LineOptions, PriceLineOptions, ChartOptions, LayoutOptions, 
    PriceScaleOptions, CrosshairOptions, TradeVisualizationOptions,
    PriceFormatOptions, RangeConfig, RangeSwitcherOptions, LegendOptions,
    TimeScaleOptions, LocalizationOptions
)
from streamlit_lightweight_charts_pro.type_definitions.enums import (
    LineStyle, LineType, LastPriceAnimationMode, PriceScaleMode,
    CrosshairMode, TradeVisualization
)
...
class TestChainableDecorators:
    ...
    def test_trade_visualization_options_chainable(self):
        ...
        result = (opts
                 .set_style(TradeVisualization.MARKERS)
