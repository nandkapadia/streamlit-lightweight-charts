...
class TestDataFrameConverter:
    ...
    def setup_method(self):
        ...
        self.single_value_df = pd.DataFrame(
            {"datetime": self.dates, "close": [100, 101, 102, 103, 104, 105, 106, 107, 108, 109]}
        )
        ...
        self.baseline_df = pd.DataFrame(
            {"datetime": self.dates, "value": [100, 101, 102, 103, 104, 105, 106, 107, 108, 109]}
        )
    ...
    def test_df_to_line_data_with_custom_value_column(self):
        ...
        df = pd.DataFrame({"datetime": self.dates[:5], "price": [100, 101, 102, 103, 104]})
    ...
    def test_df_to_line_data_with_string_dates(self):
        ...
        df = pd.DataFrame({"date": ["2024-01-01", "2024-01-02"], "close": [100, 105]})
    ...
    def test_df_to_histogram_data_with_time_column(self):
        ...
        result = df_to_histogram_data(
            self.histogram_df, value_column="volume", color_column="color", time_column="datetime"
        )
    ...
    def test_df_to_baseline_data_with_time_column(self):
        ...
        result = df_to_baseline_data(self.baseline_df, value_column="value", time_column="datetime")
    ...
    def test_df_to_baseline_data_with_custom_value_column(self):
        ...
        df = pd.DataFrame({"time": self.dates[:5], "price": [100, 101, 102, 103, 104]})
    ...
    def test_df_to_data_histogram_chart(self):
        ...
        result = df_to_data(
            self.histogram_df, "histogram", time_column="datetime", value_column="volume"
        )
    ...
    def test_dataframe_conversion_with_timezone(self):
        ...
        tz_df = pd.DataFrame({"datetime": tz_dates, "close": [100, 101, 102, 103, 104]})
    ...
    def test_dataframe_conversion_performance(self):
        ...
        large_df = pd.DataFrame(
            {"datetime": large_dates, "close": np.random.randn(10000).cumsum() + 100}
        )
    ...
    def test_histogram_conversion_with_positive_negative_values(self):
        ...
        pos_neg_df = pd.DataFrame({"datetime": self.dates[:5], "volume": [100, -50, 200, -75, 150]})
