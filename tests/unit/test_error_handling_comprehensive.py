...
class TestPriceVolumeChartErrorHandling:
    ...
    def test_invalid_data_type(self):
        ...
        # Integer data raises TypeError
        with pytest.raises(TypeError):
            PriceVolumeChart(data=123)

        # Note: None data will fail when trying to create series
        with pytest.raises(TypeError):
...
class TestChartOptionsErrorHandling:
    ...
    def test_invalid_price_scale_options(self):
        ...
        from streamlit_lightweight_charts_pro.charts.options import ChartOptions, RightPriceScale
