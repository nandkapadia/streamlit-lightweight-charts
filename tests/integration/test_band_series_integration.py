...
class TestBandSeriesIntegration:
    ...
    def test_band_series_full_integration(self):
        ...
        assert "time" in first_data_point
    ...
    def test_band_series_with_custom_styling(self):
        ...
        config = band_series.to_frontend_config()
    ...
    def test_band_series_price_scale_integration(self):
        ...
        # Price scale config is stored in the series object, not in the frontend config
        assert band_series.price_scale_config["visible"] is True
        assert band_series.price_scale_config["ticksVisible"] is True
        assert band_series.price_scale_config["borderVisible"] is True
    ...
    def test_band_series_as_overlay(self):
        ...
        candlestick_data = [
            ...
            {"time": "2024-01-02", "open": 102, "high": 107, "low": 97, "close": 104},
            {"time": "2024-01-03", "open": 104, "high": 103, "low": 93, "close": 98},
        ]
